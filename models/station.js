...
module.exports = (sequelize, DataTypes) => {
	class Station extends Model {
		 ...
		 */
		static associate({ Trip, Point, PriceLine }) {
			...
			this.hasMany(PriceLine, { foreignKey: "fromStation", as: "fromStationFK", onDelete: "cascade" });
			this.hasMany(PriceLine, { foreignKey: "toStation", as: "toStationFK", onDelete: "cascade" });
