...
import { createPromotionHeader } from "../../redux/actions/promotionHeaderAction";

export default function AddPromotionHeader(props) {
	...
	const formik = useFormik({
		...
		onSubmit: (values) => {
			dispatch(createPromotionHeader(values));
