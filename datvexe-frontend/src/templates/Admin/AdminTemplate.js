					...
					<Fragment>
						<Layout style={{minHeight: "100vh"}}>
							...
							<Layout className="site-layout">
								<Header className="flex justify-end site-layout-background" style={{padding: 0, background: "#fff"}}>
								...
								<Footer style={{textAlign: "center"}}>Created By Group 50-Double Kiệt</Footer>
							</Layout>
						</Layout>
					</Fragment>
				);
